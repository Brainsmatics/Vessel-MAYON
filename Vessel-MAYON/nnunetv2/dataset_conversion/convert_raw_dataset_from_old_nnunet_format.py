...
def convert_entry_point():
    ...
    parser.add_argument("--input_folder", type=str, default=r'K:\wufengrui\code\nnUNet\dataset\nnUNet_raw\Task601_Brain', required=False,
    ...
    parser.add_argument("--output_dataset_name", type=str, default=r'Dataset601_Brain', required=False,
