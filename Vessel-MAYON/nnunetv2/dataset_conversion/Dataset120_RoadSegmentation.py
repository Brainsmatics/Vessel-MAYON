...
if __name__ == "__main__":
    ...
    source = r'E:\huangjiang\project\nnUNet\dataset\nnUNet_raw\Task309_fiber-bundle'

    dataset_name = 'Dataset309_fiber-bundle'
    ...
    #generate_dataset_json(join(nnUNet_raw, dataset_name), {0: 'R', 1: 'G', 2: 'B'}, {'background': 0, 'fiber_bundle': 1},
        generate_dataset_json(join(nnUNet_raw, dataset_name), {0: 'R', 1: 'G', 2: 'B'},
                              {'background': 0, 'fiber_bundle': 1},
